...
class MobileFormItemStringFactory(MobileFormItemFactory):
  def __init__(self):
    MobileFormItemFactory.__init__(self,"string","String")

  def create(self):
    return MobileFormItemString(self)

  def createPreviewPanel(self):
    return MobileFormItemStringPreviewPanel(self)
    
  def createPropertiesPanel(self):
    return MobileFormItemStringPropertiesPanel(self)

class MobileFormItemString(MobileFormItem):
...
class MobileFormItemStringPropertiesPanel(MobileFormItemPanel, FormPanel):
...
class MobileFormItemStringPreviewPanel(MobileFormItemPanel, FormPanel):
  def __init__(self, factory):
    MobileFormItemPanel.__init__(self,factory)
